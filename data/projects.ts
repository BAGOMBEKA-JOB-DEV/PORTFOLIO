...
const projectsList: Project[] = [
  ...
  },
  {
    ...
    situation: [
      "Integrating an AI model into a Go service means writing the same 400 lines every time: request mapping, SSE parsing, retry with jitter, rate-limit backoff, token accounting, error classification. None of it is the product, and all of it has to be right.",
